...
## UI Improvements - Documents
- [x] Add pastel background colors to document cards (changed "other" category to cyan-50)

## Route Maps Enhancement - Tourist Attractions
- [x] Add tourist attractions to Route 1 (Bratislava → Liptovský Mikuláš) - Added Banská Bystrica Old Town, SNP Museum
- [x] Add tourist attractions to Route 2 (Liptovský Mikuláš → Košice via Slovenský Raj) - Already has multiple attractions
- [x] Add tourist attractions to Route 3 (Košice → Vienna) - Already has Schönbrunn, Belvedere
- [x] Add tourist attractions to Route 4 (Liptovský Mikuláš → Štrbské Pleso) - Already has lake, cable car
- [x] Add tourist attractions to Route 5 (Liptovský Mikuláš → Jasná) - Already has ski resort, caves
- [x] Add tourist attractions to Route 6 (Vienna → Bratislava Airport) - Airport route

## Hotel Images
- [ ] Verify and integrate GOLDEN hotel image upload - User will upload later
